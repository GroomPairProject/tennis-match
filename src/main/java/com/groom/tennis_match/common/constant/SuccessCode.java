...
public enum SuccessCode {
    ...
    // ==================== 관리자 관련 ====================
    /** 관리자 생성 성공 */
    ADMIN_CREATE_SUCCESS("S111", "관리자가 성공적으로 생성되었습니다"),
    /** 관리자 조회 성공 */
    ADMIN_READ_SUCCESS("S112", "관리자 정보를 성공적으로 조회했습니다"),
    /** 관리자 수정 성공 */
    ADMIN_UPDATE_SUCCESS("S113", "관리자 정보가 성공적으로 수정되었습니다"),
    /** 관리자 삭제 성공 */
    ADMIN_DELETE_SUCCESS("S114", "관리자가 성공적으로 삭제되었습니다"),
